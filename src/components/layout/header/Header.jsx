      ...
      <div className="fixed left-0 top-0 h-full bg-gray-100 p-0 z-0">
        <div className="flex flex-col text-lg gap-16 mt-24">
          {menu.map((item, index) => (
            ...
            >
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-300 ease-in  border-b-4 mt-11 focus:outline-none rounded border-sky-500 m-auto"></div>
