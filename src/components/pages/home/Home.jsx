...
export default function Home() {
  return (
    <div className="flex items-center justify-center h-screen relative">
      ...
      >
        <div
          className="aspect-[1055/778] w-[77.1875rem] max-sm:w-[20.1875rem] bg-gradient-to-tr from-[#96cdfa] to-[#0c80ec] opacity-50 max-sm:opacity-100 "
          style={{
            clipPath:
        ...
        />
        <div
          className="aspect-[1055/778] w-[77.1875rem] max-sm:mt-96 max-sm:w-[20.1875rem] bg-gradient-to-tr from-[#96cdfa] to-sky-500 opacity-50 max-sm:opacity-90 "
          style={{
            clipPath:
              "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
          }}
