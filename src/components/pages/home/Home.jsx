...
export default function Home() {
  return (
    <div className="flex items-center justify-center h-screen">
      ...
      <div
        className="absolute left-1/2 top-0 -z-10 -translate-x-1/2 blur-3xl xl:-top-6 animate-swing"
        aria-hidden="true"
      >
        <div
          className="aspect-[1055/778] w-[77.1875rem] max-sm:w-[20.1875rem]  bg-gradient-to-tr from-[#96cdfa] to-[#0c80ec] opacity-50"
          style={{
            clipPath:
