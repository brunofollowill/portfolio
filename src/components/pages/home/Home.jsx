  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="text-center">
        ...
        <h3 className="text-gray-700 text-3xl sm:text-3xl mt-1 ml-1 text-left font-thin">
          Software Developer
        </h3>
        <p className="xl:w-2/3 max-w-[750px] text-left sm:w-96 text-xl font-light mt-10 text-gray-700">
      ...
      >
        <div
          className="aspect-[1055/778] w-[77.1875rem] bg-gradient-to-tr from-[#96cdfa] to-[#0c80ec] opacity-30"
          style={{
            clipPath:
